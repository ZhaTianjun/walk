...
private:
    ...
    std::multimap<pair<double,double>,GridNodePtr> openSet;
...
public:
    LPAstarPlanner();
    LPAstarPlanner(vector<vector<int>>  data_);
    void initialize();
    void LPAstarGraphSearch(pair<int,int> start_,pair<int,int> goal_);
